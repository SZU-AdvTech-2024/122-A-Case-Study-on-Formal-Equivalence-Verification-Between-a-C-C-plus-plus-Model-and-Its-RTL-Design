...
//Widden Begin
//rv_vfwmacc_vf
tuple<ui128, ui5> rv_vfwmacc_vf(ui128 vs1, ui128 vs2, ui3 frm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vta) {
  ui128 vd   = 0;
  ui5 fflags = 0;
  ...
  if (vsew == 0x2) {
     ...
     for (uint i = 0; i < 2; i++) {
        ...
        f_oldvd.v = oldvd_arr;
        if ((i >= vstart) && (i < vl)) {
           f_vd    = f64_mulAdd(f32_to_f64(f_vs2), f32_to_f64(f_vs1), f_oldvd);
           vd_arr  = f_vd.v;
...
//rv_vfwmacc_vv
tuple<ui128, ui5> rv_vfwmacc_vv(ui128 vs1, ui128 vs2, ui3 frm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vta) {
  ui128 vd   = 0;
  ui5 fflags = 0;
  softfloat_roundingMode = frm;
  softfloat_exceptionFlags = 0;
...
//rv_vfwnmacc_vf
tuple<ui128, ui5> rv_vfwnmacc_vf(ui128 vs1, ui128 vs2, ui3 frm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vta) {
  ui128 vd   = 0;
  ui5 fflags = 0;
  softfloat_roundingMode = frm;
  softfloat_exceptionFlags = 0;
...
//rv_vfwnmacc_vv
tuple<ui128, ui5> rv_vfwnmacc_vv(ui128 vs1, ui128 vs2, ui3 frm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vta) {
  ui128 vd   = 0;
  ui5 fflags = 0;
  softfloat_roundingMode = frm;
  softfloat_exceptionFlags = 0;
...
//rv_vfwmsac_vf
tuple<ui128, ui5> rv_vfwmsac_vf(ui128 vs1, ui128 vs2, ui3 frm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vta) {
  ui128 vd   = 0;
  ui5 fflags = 0;
  softfloat_roundingMode = frm;
  softfloat_exceptionFlags = 0;
...
//rv_vfwmsac_vv
tuple<ui128, ui5> rv_vfwmsac_vv(ui128 vs1, ui128 vs2, ui3 frm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vta) {
  ui128 vd   = 0;
  ui5 fflags = 0;
  softfloat_roundingMode = frm;
  softfloat_exceptionFlags = 0;
...
//rv_vfwnmsac_vf
tuple<ui128, ui5> rv_vfwnmsac_vf(ui128 vs1, ui128 vs2, ui3 frm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vta) {
  ui128 vd   = 0;
  ui5 fflags = 0;
  softfloat_roundingMode = frm;
  softfloat_exceptionFlags = 0;
...
//rv_vfwnmsac_vv
tuple<ui128, ui5> rv_vfwnmsac_vv(ui128 vs1, ui128 vs2, ui3 frm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vta) {
  ui128 vd   = 0;
  ui5 fflags = 0;
  softfloat_roundingMode = frm;
  softfloat_exceptionFlags = 0;
...
void hector_wrapper()
{
    ...
    vd = 0;
    fflags = 0;
    if((funct6 == 0x3C) && (funct3 == 0x5) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (Mask == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwmacc_vf(vs1, vs2, frm, oldvd, vstart, vl, vsew, vta); }
    if((funct6 == 0x3C) && (funct3 == 0x1) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (Mask == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwmacc_vv(vs1, vs2, frm, oldvd, vstart, vl, vsew, vta); }
    if((funct6 == 0x3D) && (funct3 == 0x5) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (Mask == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwnmacc_vf(vs1, vs2, frm, oldvd, vstart, vl, vsew, vta); }
    if((funct6 == 0x3D) && (funct3 == 0x1) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (Mask == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwnmacc_vv(vs1, vs2, frm, oldvd, vstart, vl, vsew, vta); }
    if((funct6 == 0x3E) && (funct3 == 0x5) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (Mask == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwmsac_vf(vs1, vs2, frm, oldvd, vstart, vl, vsew, vta); }
    if((funct6 == 0x3E) && (funct3 == 0x1) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (Mask == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwmsac_vv(vs1, vs2, frm, oldvd, vstart, vl, vsew, vta); }
    if((funct6 == 0x3F) && (funct3 == 0x5) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (Mask == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwnmsac_vf(vs1, vs2, frm, oldvd, vstart, vl, vsew, vta); }
    if((funct6 == 0x3F) && (funct3 == 0x1) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (Mask == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwnmsac_vv(vs1, vs2, frm, oldvd, vstart, vl, vsew, vta); }
