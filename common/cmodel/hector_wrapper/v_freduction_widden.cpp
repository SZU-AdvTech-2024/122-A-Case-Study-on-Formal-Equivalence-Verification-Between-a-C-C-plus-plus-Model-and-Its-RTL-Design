...
//Widden Begin
//rv_vfwredosum_vs
tuple<ui128, ui5> rv_vfwredosum_vs(ui128 vs1, ui128 vs2, ui128 vm, ui3 frm, ui128 oldvd, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd   = 0;
  ui5 fflags = 0;
     ...
     for (uint i = 0; i < 4; i++) {
        ...
        if (i < vl) {
           if ((Mask == 1) && (vm[i] == 0)) {
              ...
              f_vd    = f64_add(f32_to_f64(f_vs2), f_vd);
              vd_arr  = f_vd.v;
...
void hector_wrapper()
{
    ...
    vd = 0;
    fflags = 0;
    if((funct6 == 0x31) && (funct3 == 0x1) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (vstart == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwredosum_vs(vs1, vs2, vm, frm, oldvd, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x33) && (funct3 == 0x1) && (Narrow == 0x0) && (Widden == 0x1) && (MaskOp == 0x0) && (vstart == 0x0) && (eewType_1 == 0x3)) { tie(vd,fflags) = rv_vfwredosum_vs(vs1, vs2, vm, frm, oldvd, vl, vsew, vma, vta, Mask); }
