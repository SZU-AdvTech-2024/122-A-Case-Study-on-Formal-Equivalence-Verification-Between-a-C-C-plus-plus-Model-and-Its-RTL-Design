...
//vwmulsu_vv
ui128 rv_vwmulsu_vv(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
//vwmulsu_vx
ui128 rv_vwmulsu_vx(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
//vwmulu_vv
ui128 rv_vwmulu_vv(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
//vwmulu_vx
ui128 rv_vwmulu_vx(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
//vwmacc_vv
ui128 rv_vwmacc_vv(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
     for (uint i = 0; i < 8; i++) {
        ...
        if ((i >= vstart) && (i < vl)) {
           if ((Mask == 1) && (vm[i] == 0)) {
              ...
              vd_arr  = vs1_arrext * vs2_arrext + oldvd_arr;
           }
           vd.set_slc(i*16,vd_arr);
        } else if ((i < vstart) || ((i >= vl) && (vta == 0)) || (vstart >= vl)) {
           vd.set_slc(i*16,oldvd_arr);
...
//vwmacc_vx
ui128 rv_vwmacc_vx(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
//vwmaccsu_vv
ui128 rv_vwmaccsu_vv(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
//vwmaccsu_vx
ui128 rv_vwmaccsu_vx(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
//vwmaccu_vv
ui128 rv_vwmaccu_vv(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
//vwmaccu_vx
ui128 rv_vwmaccu_vx(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
//vwmaccus_vx
ui128 rv_vwmaccus_vx(ui128 vs1, ui128 vs2, ui128 vm, ui128 oldvd, ui7 vstart, ui8 vl, ui3 vsew, bool vma, bool vta, bool Mask) {
  ui128 vd = 0;
  if (vsew == 0x0) {
     ui8 vs1_arr, vs2_arr;
     ui16 vs1_arrext, vs2_arrext, oldvd_arr, vd_arr;
...
void hector_wrapper()
{
    ...
    vd = 888;
    if((funct6 == 0x3B) && (funct3 == 0x2) && (Widden == 0x1)) { vd = rv_vwmul_vv(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x3B) && (funct3 == 0x6) && (Widden == 0x1)) { vd = rv_vwmul_vx(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x3A) && (funct3 == 0x2) && (Widden == 0x1)) { vd = rv_vwmulsu_vv(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x3A) && (funct3 == 0x6) && (Widden == 0x1)) { vd = rv_vwmulsu_vx(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x38) && (funct3 == 0x2) && (Widden == 0x1)) { vd = rv_vwmulu_vv(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x38) && (funct3 == 0x6) && (Widden == 0x1)) { vd = rv_vwmulu_vx(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }

    if((funct6 == 0x3D) && (funct3 == 0x2) && (Widden == 0x1)) { vd = rv_vwmacc_vv(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x3D) && (funct3 == 0x6) && (Widden == 0x1)) { vd = rv_vwmacc_vx(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x3F) && (funct3 == 0x2) && (Widden == 0x1)) { vd = rv_vwmaccsu_vv(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x3F) && (funct3 == 0x6) && (Widden == 0x1)) { vd = rv_vwmaccsu_vx(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x3C) && (funct3 == 0x2) && (Widden == 0x1)) { vd = rv_vwmaccu_vv(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x3C) && (funct3 == 0x6) && (Widden == 0x1)) { vd = rv_vwmaccu_vx(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
    if((funct6 == 0x3E) && (funct3 == 0x6) && (Widden == 0x1)) { vd = rv_vwmaccus_vx(vs1, vs2, vm, oldvd, vstart, vl, vsew, vma, vta, Mask); }
