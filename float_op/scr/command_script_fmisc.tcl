...
proc compile_spec {} {
    ...
    create_design -cov -name spec -top hector_wrapper
    cppan \
          ...
          ../../../common/cmodel/hector_wrapper/fmisc.cc \
          $SF_OPTIONS
...
#    set fcvt_s_d_active    "(spec.fuType(1) == 5'b01010) && (spec.rfWen(1) == 1'b0) && (spec.fpWen(1) == 1'b1) && (spec.tagIn(1) == 1'b1) && (spec.TagOut(1) == 1'b0) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b1) && (spec.typ(1) == 2'b01) && (spec.fmt(1) == 2'b00)"
    set fcvt_d_s_active    "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b01) && (spec.fcvt(1) == 1'b1) && (spec.isBf16(1) == 1'b0)"
    set fcvt_s_h_active    "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b00) && (spec.fcvt(1) == 1'b1) && (spec.isBf16(1) == 1'b0)"
    set fcvt_d_h_active    "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b01) && (spec.fcvt(1) == 1'b1) && (spec.isBf16(1) == 1'b0)"
    set fcvt_s_d_active    "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b00) && (spec.fcvt(1) == 1'b1) && (spec.isBf16(1) == 1'b0)"
    set fcvt_h_s_active    "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b10) && (spec.fcvt(1) == 1'b1) && (spec.isBf16(1) == 1'b0)"
    set fcvt_h_d_active    "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b10) && (spec.fcvt(1) == 1'b1) && (spec.isBf16(1) == 1'b0)"
    set fsgnj_h_active     "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b10) && (spec.wflags(1) == 1'b0) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0)"
    set fsgnjn_h_active    "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b10) && (spec.wflags(1) == 1'b0) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0)"
    set fsgnjx_h_active    "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b10) && (spec.wflags(1) == 1'b0) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0)"
    set fsgnj_s_active     "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b00) && (spec.wflags(1) == 1'b0) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0)"
    set fsgnjn_s_active    "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b00) && (spec.wflags(1) == 1'b0) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0)"
    set fsgnjx_s_active    "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b00) && (spec.wflags(1) == 1'b0) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0)"
    set fsgnj_d_active     "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b0) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0)"
    set fsgnjn_d_active    "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b0) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0)"
    set fsgnjx_d_active    "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b0) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0)"
    set fmin_h_active      "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b10) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b1)"
    set fmax_h_active      "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b10) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b1)"
    set fmin_s_active      "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b00) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b1)"
    set fmax_s_active      "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b00) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b1)"
    set fmin_d_active      "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b1)"
    set fmax_d_active      "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b1)"

    set feq_s_active       "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b0)"
    set flt_s_active       "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b0)"
    set fle_s_active       "(spec.tagIn(1) == 2'b00) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b0)"
    set feq_d_active       "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b0)"
    set flt_d_active       "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b0)"
    set fle_d_active       "(spec.tagIn(1) == 2'b01) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b0)"
    set feq_h_active       "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b0)"
    set flt_h_active       "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b0)"
    set fle_h_active       "(spec.tagIn(1) == 2'b10) && (spec.TagOut(1) == 2'b01) && (spec.wflags(1) == 1'b1) && (spec.fcvt(1) == 1'b0) && (spec.isBf16(1) == 1'b0) && (spec.fpWen(1) == 1'b0)"
