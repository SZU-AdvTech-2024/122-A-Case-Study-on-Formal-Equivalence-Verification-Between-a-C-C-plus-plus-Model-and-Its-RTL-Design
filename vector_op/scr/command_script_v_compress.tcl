...
set case1_sew8 "(spec.vs2(1) == impl.io_in_rdata(15)) && (spec.oldvd(1) == impl.io_in_rdata(15)) && (spec.vsew(1) == 3'b0) && (spec.vl(1) == 8'h10) && (spec.vm(1)[15:0] == 16'hffff)"
set case2_sew8 "(spec.vs2(1) == impl.io_in_rdata(15)) && (spec.oldvd(1) == impl.io_in_rdata(17)) && (spec.vsew(1) == 3'b0) && (spec.vl(1) != 8'h10) && (spec.vm(1)[15:0] == 16'hffff) && (spec.vta(1) == 3'b0)"
set case3_sew8 "(spec.vs2(1) == impl.io_in_rdata(15)) && (spec.oldvd(1) == impl.io_in_rdata(15)) && (spec.vsew(1) == 3'b0) && (spec.vl(1) != 8'h10) && (spec.vm(1)[15:0] == 16'hffff) && (spec.vta(1) == 3'b1)"
set case4_sew8 "(spec.vs2(1) == impl.io_in_rdata(15)) && (spec.oldvd(1) == impl.io_in_rdata(17)) && (spec.vsew(1) == 3'b0) && (spec.vm(1)[15:0] != 16'hffff) && (spec.vta(1) == 3'b0)"
set case5_sew8 "(spec.vs2(1) == impl.io_in_rdata(15)) && (spec.oldvd(1) == impl.io_in_rdata(15)) && (spec.vsew(1) == 3'b0) && (spec.vm(1)[15:0] != 16'hffff) && (spec.vta(1) == 3'b1)"

lemma result_vcompress_vm_sew8_case1    = ($vcompress_vm_active && ($common_split_rule) && ($case1_sew8)) -> (spec.vd(1) == impl.io_out_wb_data(21))
lemma result_vcompress_vm_sew8_case2    = ($vcompress_vm_active && ($common_split_rule) && ($case2_sew8)) -> (spec.vd(1) == impl.io_out_wb_data(23))
lemma result_vcompress_vm_sew8_case3    = ($vcompress_vm_active && ($common_split_rule) && ($case3_sew8)) -> (spec.vd(1) == impl.io_out_wb_data(23))
lemma result_vcompress_vm_sew8_case4    = ($vcompress_vm_active && ($common_split_rule) && ($case4_sew8)) -> (spec.vd(1) == impl.io_out_wb_data(23))
lemma result_vcompress_vm_sew8_case5    = ($vcompress_vm_active && ($common_split_rule) && ($case5_sew8)) -> (spec.vd(1) == impl.io_out_wb_data(23))

lemma valid_sew8_case1                  = ($vcompress_vm_active && ($common_split_rule) && ($case1_sew8)) -> (impl.io_out_wb_vld(21) == 1'b1)
lemma valid_sew8_case2                  = ($vcompress_vm_active && ($common_split_rule) && ($case2_sew8)) -> (impl.io_out_wb_vld(23) == 1'b1)
lemma valid_sew8_case3                  = ($vcompress_vm_active && ($common_split_rule) && ($case3_sew8)) -> (impl.io_out_wb_vld(23) == 1'b1)
lemma valid_sew8_case4                  = ($vcompress_vm_active && ($common_split_rule) && ($case4_sew8)) -> (impl.io_out_wb_vld(23) == 1'b1)
lemma valid_sew8_case5                  = ($vcompress_vm_active && ($common_split_rule) && ($case5_sew8)) -> (impl.io_out_wb_vld(23) == 1'b1)
