...
proc compile_spec {} {
        ...
        cppan \
              ...
              ../../../common/cmodel/hector_wrapper/v_reduction_widden.cpp
...
set vwredsum_vs_active    "(spec.funct6(1) == 6'h31) && (spec.funct3(1) == 3'h00) && (spec.Widden(1) == 1'b1) && (spec.vstart(1) == 7'h0) && (spec.eewType_1(1) == 3'h3)"
set vwredsumu_vs_active   "(spec.funct6(1) == 6'h30) && (spec.funct3(1) == 3'h00) && (spec.Widden(1) == 1'b1) && (spec.vstart(1) == 7'h0) && (spec.eewType_1(1) == 3'h3)"
...
lemma result_vwredsum_vs    = ($vwredsum_vs_active    && ($common_split_rule)) -> (spec.vd(1) == impl.auto_writeback_out_bits_data(9))
lemma result_vwredsumu_vs   = ($vwredsumu_vs_active   && ($common_split_rule)) -> (spec.vd(1) == impl.auto_writeback_out_bits_data(9))
...
proc case_split_vector {} {
    ...
    caseEnumerate vl_sew8  -expr spec.vl[2:0] -parent sew8 -type full
#    caseEnumerate vl_sew8  -expr "spec.vl(1)<=8'h8" -parent sew8 -type full

    caseBegin sew16
    caseAssume (spec.vsew(1) == 3'b001)
    caseEnumerate vl_sew16 -expr spec.vl[1:0] -parent sew16 -type full
#    caseEnumerate vl_sew16 -expr "spec.vl(1)<=8'h4" -parent sew16 -type full

    caseBegin sew32
    caseAssume (spec.vsew(1) == 3'b010)
    caseEnumerate vl_sew32 -expr spec.vl[0] -parent sew32 -type full
#    caseEnumerate vl_sew32 -expr "spec.vl(1)<=8'h2" -parent sew32 -type full
